            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <hr>
                  <form class="forms-sample" action="/admin/barang/create" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" autofocus required class="form-control" name="harga" placeholder="Masukan Harga Barang...">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="exampleInputUsername1">Id Satuan Barang</label>
                        <input type="text" autofocus required class="form-control" name="id_satuan" placeholder="Masukan Id Satuan Barang...">
                      </div>
                      <div class="form-group">
