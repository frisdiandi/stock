              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex justify-content-between">
                    <h3><i class="ti-pencil"></i> Edit Jenis Barang</h3>
                  ...
                  <hr>
                  <form class="forms-sample" action="/admin/jenis_barang/update/{{$jenis->id}}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="form-group">
                      <label for="exampleInputUsername1">Nama Jenis Barang</label>
                      <input type="text" autofocus required class="form-control" name="nama" placeholder="Masukan Nama Jenis Produk..." value="{{$jenis->nama}}">
                    </div>
